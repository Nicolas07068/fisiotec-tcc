...
export default function Home() {
  return (
    ...
    <main className="relative  bg-gradient-to-t from-bg-telas via-bghome2 to-bghome1 min-h-screen overflow-x-hidden ">
        <Header></Header>
      <div className="px-4">
        <div className="mt-10 xl:mt-20 flex flex-col xl:flex-row xl:items-center xl:ml-20  ">
          ...
          <div className="flex justify-center mt-10 lg:mt-0 lg:w-2/5  ">
            <img src={FotoHeader} alt="Imagem de um senhor" className="w-full h-auto max-w-xs lg:max-w-full  xl:ml-10" />
          </div>
        </div>
      </div>
    </main>
