  ...
  return (
    <div className=''>
        ...
        <div className='xl:flex xl:max-w-7xl xl:m-auto'>
          ...
          <a href="/produto"><button className='mt-6 bg-gradient-to-l  from-verdinho via-azulzinho to-roxinho text rounded-3xl p-1 text-white ml-6 mb-10 w-36 xl:mb-0'>Veja Mais</button></a>
          </div>
