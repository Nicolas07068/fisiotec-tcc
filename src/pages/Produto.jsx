...
export default function Produto() {
  return (
    <section>
        <Header></Header>
       <div className='max-h-screen text-justify'>
            <div className='text-3xl font-semibold ml-7 xl:text-3xl xl:flex xl:items-center xl:justify-center '>
                ...
                <div className='flex items-center justify-center mt-10 text-white text-[12px] gap-5 xl:flex-row xl:mr-[350px] xl:-mt-4 '>
                    <div>
                    ...
                    <div className='ml-3 xl:ml-20'>
                        <img src={CerebroImg} alt="" className='xl:ml-20 ml-10 h-16 mb-2' />
                    ...
                    <div className='flex items-center justify-center  mt-10 text-white gap-5 text-[12px] xl:flex-col xl:ml-[650px] xl:-mt-[258px] '>
                            <div>
                            <img src={MaoLampadaImg} alt="" className='xl:ml-20 ml-9'/>
                            <p className='xl:h-44 xl:w-48 w-32 text-justify'><i>A luva destaca-se pela tecnologia inovadora do Arduino, foco na reabilitação, acessibilidade financeira e facilidade de uso, garantindo eficácia e inclusão para usuários de diferentes perfis.</i></p>
                            </div>

                            <div className='ml-3 xl:ml-0'>
                            <img src={CirculoImg} alt="" className='xl:ml-20 xl:mb-3 ml-8 ' />
                    ...
                    <div className='flex flex-col items-center mt-10 mb-10 xl:relative xl:right-[350px] xl:-top-[300px]'>
                        <img src={MaoRoboticaImg} alt="" className='mb-4 ' />
                        <p className='text-white text-[12px] text-center w-44 text-justify'>
