...
export default function Produto() {
  return (
    <section>
        ...
        <h2 className=' text-gradient bg-gradient-to-l  from-verdinho  via-roxinho to-azulzinho bg-clip-text text-transparent mb-10'>PRODUTO</h2>
        </div>
        <p className='ml-7 text-white h-44 w-60 xl:text-sm'><i>A Luva Robótica Terapêutica visa melhorar a qualidade de vida e promover a autonomia de pessoas com dificuldades motoras, facilitando a reabilitação em casa.</i></p>

        <div className='flex items-center justify-center  mt-10 text-white text-[10px]'>
            <div>
            ...
            <div className='flex flex-col items-center mt-10 mb-10'>
                ...
                <p className='text-white text-[10px] text-center w-44'>
