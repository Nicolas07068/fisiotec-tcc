    ...
    <section>
       ...
       <div className='max-h-screen'>
            <div className='text-3xl font-semibold ml-7 xl:text-3xl xl:flex xl:items-center xl:justify-center '>
                ...
                <p className='ml-7 text-white h-44  xl:text-sm  xl:h-16 xl:flex xl:items-center xl:justify-center text-justify '><i>A Luva Robótica Terapêutica visa melhorar a qualidade de vida e promover a autonomia de pessoas com dificuldades motoras, facilitando a reabilitação em casa.</i></p>
