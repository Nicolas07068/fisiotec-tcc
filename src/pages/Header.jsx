    ...
    <header className="bg-bg-header w-full flex flex-col md:flex-row items-center justify-between px-4 py-2 ">
      <div className="flex items-center w-full md:w-auto">
        ...
        <h1 className="font-bold text-white ml-4">
          FISIO 
          <strong className="text-gradient bg-gradient-to-l from-verdinho via-roxinho to-azulzinho bg-clip-text text-transparent">
            TEC
          </strong>
        </h1>
      </div>
      <nav className={`w-full md:w-auto ${isMenuOpen ? 'block' : 'hidden'} md:flex md:space-x-4 mt-4 md:mt-0`}>
